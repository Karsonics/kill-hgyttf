...
import {UserLogoutResponce} from "../models/messages/UserLogoutResponce";
...
export class ControllerUsers {
    ...
    @Post("logout")
    public async logout(@Body() request: UserLogoutRequest): Promise<UserLogoutResponce> {
        let response: UserLogoutResponce = {
            is_success: false,
